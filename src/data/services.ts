export type Service = { n: string; name: string; desc: string };
...
export const practices: Practice[] = [
  {
    slug: "seguridad-ofensiva",
    title: "Seguridad Ofensiva",
    blurb: "Atacamos como lo haría un adversario real, para que nadie más pueda.",
    services: [
      {
        n: "01",
  ...
  {
    slug: "deteccion-y-monitoreo",
    title: "Detección y Monitoreo",
    blurb: "Ojos sobre la superficie de ataque, las 24 horas, todos los días.",
    services: [
      {
        n: "09",
  ...
  },
  {
    ...
    blurb: "Del gap analysis a la certificación, con el regulador argentino en mente.",
    services: [
      {
        n: "14",
  ...
  },
  {
    ...
    blurb: "Cuando ya pasó, las primeras horas definen el costo total.",
    services: [
      {
        n: "18",
  ...
  },
  {
    ...
    blurb: "La mayoría de las brechas cloud no son exploits: son configuración.",
    badge: "NUEVO",
    services: [
      {
        n: "22",
  ...
  },
  {
    ...
    blurb: "Seguridad dentro del ciclo de desarrollo, no como auditoría posterior.",
    services: [
      {
        n: "27",
        name: "SAST Continuo",
  ...
  {
    slug: "servicios-de-inteligencia",
    title: "Servicios de Inteligencia",
    blurb: "Contexto sobre el adversario antes de que el adversario actúe.",
    services: [
      {
        n: "31",
  ...
  {
    slug: "industrial-e-iot",
    title: "Industrial & IoT Security",
    blurb: "Donde un incidente digital tiene consecuencias físicas.",
    services: [
      {
        n: "35",
  ...
  {
    slug: "ia-y-tecnologia-emergente",
    title: "IA & Tecnología Emergente",
    blurb: "El nuevo perímetro: modelos, agentes y los datos que los alimentan.",
    badge: "NUEVO",
    services: [
      {
        n: "37",
  ...
  {
    slug: "web3-y-blockchain",
    title: "Web3 & Blockchain Security",
    blurb: "Auditoría de contratos y trazabilidad on-chain con validez pericial.",
    badge: "NUEVO",
    services: [
      {
        n: "41",
  ...
  {
    slug: "zero-trust-y-arquitectura",
    title: "Zero Trust & Arquitectura",
    blurb: "Rediseñar el acceso para que un compromiso no se propague.",
    services: [
      {
        n: "45",
  ...
  {
    slug: "gobierno-y-defensa",
    title: "Gobierno y Defensa",
    blurb: "Capacidades de inteligencia para organismos públicos y fuerzas de seguridad.",
    badge: "GOV",
    services: [
      {
        n: "48",
  ...
  },
  {
    ...
    blurb: "Operación completa cuando no hay equipo interno para sostenerla.",
    services: [
      {
        n: "54",
...
export const practiceCount = practices.length;
export const serviceCount = practices.reduce((total, p) => total + p.services.length, 0);
